    ...
    <div className="min-h-screen h-full w-full flex flex-col bg-brand-light overflow-hidden">
      ...
      <header className="min-w-full text-gray-800 py-14 px-4 md:px-0">
        <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
            ...
            <Link to={'/'} className="font-coiny text-xl md:text-3xl font-bold">
            ...
            <nav>
              <ul className="flex items-center space-x-4 md:space-x-6">
                ...
                <li className="cursor-pointer">
                  <a
                    href="https://twitter.com/RacoonBears"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
       ...
       <div className=" h-full w-full container max-w-5xl mx-auto items-center pt-4"> 
          <div className="flex flex-col  mt-16 font-coiny uppercase items-center justify-center rounded"> {/* about */}
            ...
            <Link to={'/minting'} className="mt-16 font-coiny uppercase inline-flex items-center px-6 py-2 text-sm sm:text-2xl md:text-3xl font-medium text-center rounded text-rose-500 hover:bg-rose-600 hover:text-white">
              Go to minting page
              <svg
                xmlns="http://www.w3.org/2000/svg"
